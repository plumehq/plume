  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        default:
          "size-full px-4 pb-72 pt-2 text-base sm:px-[max(16px,calc(25%-350px))]",
        demo: "size-full px-4 pb-72 pt-2 text-base sm:px-[max(16px,calc(25%-350px))]",
        fullWidth: "size-full px-4 pb-72 pt-2 text-base sm:px-6",
        none: "",
